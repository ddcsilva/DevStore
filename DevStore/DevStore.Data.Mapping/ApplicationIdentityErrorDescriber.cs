...
namespace DevStore.Data.Mapping
{
    public class ApplicationIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError LoginAlreadyAssociated() { return new IdentityError { Code = nameof(LoginAlreadyAssociated), Description = "Já existe um usuário com este email." }; }
        public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"Email '{userName}' é inválido, pode conter apenas letras ou dígitos." }; }
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"Email '{userName}' já está sendo utilizado." }; }
